  ...
  it("keeps outreach writer copy available in every supported language", () => {
    ...
    for (const language of languages) {
      ...
      const visibleCopy = [
        ...
        copy.devLetter.batch.recipientStatus.replied,
        copy.devLetter.batch.recipientStatus.bounced,
        copy.devLetter.batch.followUpTitle,
        copy.devLetter.batch.followUpSummary(2, 1, 0),
        copy.devLetter.batch.followUpMetrics.ready,
        copy.devLetter.batch.followUpNext(1, "Atlas", "2026-06-09"),
        copy.devLetter.batch.followUpStatus.ready,
        copy.devLetter.batch.status.created(2),
        copy.devLetter.batch.status.sent(1),
        copy.devLetter.batch.status.followUpsScheduled(3),
        copy.devLetter.batch.status.inboxChecked(1, 1),
        copy.devLetter.batch.warnings.noApproved,
        copy.devLetter.quality.title,
        copy.devLetter.quality.notReviewed,
        copy.devLetter.quality.stale,
        copy.devLetter.quality.score(88),
        copy.devLetter.quality.review,
        copy.devLetter.quality.rewrite,
        copy.devLetter.quality.passed,
        copy.devLetter.quality.needsRewrite,
        copy.devLetter.quality.blockedSend,
        copy.devLetter.quality.blockedApprove,
        copy.devLetter.quality.checks.buyerReason,
        copy.devLetter.quality.checks.humanTone,
        copy.devLetter.quality.checks.personalized,
        copy.devLetter.quality.checks.nextStep,
        copy.devLetter.quality.checks.twoSecondRead,
      ];
