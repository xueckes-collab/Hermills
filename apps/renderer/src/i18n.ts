...
const en: UiCopy = {
  ...
  onboarding: {
    ...
    themeOptions: {
      ...
      system: { label: 'Automatic', detail: 'Follow this computer system appearance.' },
    },
  ...
  computerControl: {
    ...
    subtitle: 'Ask in chat when you want Hermes to operate this computer.',
    ...
    consoleReady: 'Hermes can operate this computer from chat.',
  ...
  chat: {
    ...
    you: 'You',
    emptyTitle: 'Ask Hermes anything on this computer.',
    ...
    emptyActions: {
      quickChat: { title: 'Ask a question', description: 'Start a normal chat and let Hermes answer from this computer.', action: 'Start chat', prompt: 'Help me think through this.' },
  ...
  runtime: {
    ...
    title: { setupRetry: 'Setup needs a retry.', settingUp: 'Setting up Hermes.', setupOnce: 'Set up Hermes once on this computer.', hasUpdate: 'Hermes has an update.', ready: 'Hermes is ready.', needsRepair: 'Hermes needs repair.', installed: 'Hermes is installed.' },
...
const zhCN = withOverrides(en, {
  ...
  onboarding: {
    ...
    themeOptions: { warm: { label: '暖纸', detail: '柔和纸面和蓝绿色重点。' }, night: { label: '青夜', detail: '低亮度深色，适合夜间工作。' }, plain: { label: '素白', detail: '高对比，简单清爽。' }, system: { label: '自动', detail: '跟随这台电脑的系统外观。' } },
  ...
  computerControl: {
    ...
    consoleTitle: '电脑操作',
    consoleReady: 'Hermes 可以在聊天里操作这台电脑。',
  ...
  runtime: {
    ...
    title: { setupRetry: '设置需要重试。', settingUp: '正在设置 Hermes。', setupOnce: '在这台电脑上设置一次 Hermes。', hasUpdate: 'Hermes 有更新。', ready: 'Hermes 已就绪。', needsRepair: 'Hermes 需要修复。', installed: 'Hermes 已安装。' },
...
const zhTW = withOverrides(zhCN, {
  ...
  onboarding: {
    ...
    themeOptions: { warm: { label: '暖紙', detail: '柔和紙面和藍綠色重點。' }, night: { label: '青夜', detail: '低亮度深色，適合夜間工作。' }, plain: { label: '素白', detail: '高對比，簡單清爽。' }, system: { label: '自動', detail: '跟隨這台電腦的系統外觀。' } },
  ...
  firstRun: { setupEyebrow: '設定', checkingTitle: '正在檢查這台電腦。', checkingDescription: '設定完成後 Hermes 會進入聊天。', oneTimeSetup: '一次性設定', packageCheckFallback: 'Hermes 會先檢查官方安裝包。' },
  ...
  runtime: {
    ...
    title: { setupRetry: '設定需要重試。', settingUp: '正在設定 Hermes。', setupOnce: '在這台電腦上設定一次 Hermes。', hasUpdate: 'Hermes 有更新。', ready: 'Hermes 已就緒。', needsRepair: 'Hermes 需要修復。', installed: 'Hermes 已安裝。' },
...
const ja = withOverrides(en, {
  ...
  runtime: {
    ...
    title: { setupRetry: '設定の再試行が必要です。', settingUp: 'Hermes を設定しています。', setupOnce: 'このコンピューターで Hermes を一度だけ設定します。', hasUpdate: 'Hermes の更新があります。', ready: 'Hermes は準備完了です。', needsRepair: 'Hermes の修復が必要です。', installed: 'Hermes はインストール済みです。' },
...
const ko = withOverrides(en, {
  ...
  runtime: {
    ...
    title: { setupRetry: '설정을 다시 시도해야 합니다.', settingUp: 'Hermes를 설정하는 중입니다.', setupOnce: '이 컴퓨터에서 Hermes를 한 번 설정합니다.', hasUpdate: 'Hermes 업데이트가 있습니다.', ready: 'Hermes가 준비되었습니다.', needsRepair: 'Hermes 복구가 필요합니다.', installed: 'Hermes가 설치되어 있습니다.' },
